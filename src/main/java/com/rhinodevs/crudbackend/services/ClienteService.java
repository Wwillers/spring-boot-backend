...
public class ClienteService {
	...
	public Cliente fromDTO(ClienteNewDTO objDto) {
		...
		Endereco endereco = new Endereco(null, objDto.getLogradouro(), objDto.getNome(), objDto.getComplemento(),
	...
	public URI uploadProfilePicture(MultipartFile multipartFile) {
		...
		return s3Service.uploadFile(imageService.getInputStream(jgpImage, "jpg"), fileName, "image");
	}
}
