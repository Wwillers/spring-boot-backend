...
import com.rhinodevs.crudbackend.domain.PagamentoComCartao;
...
import com.rhinodevs.crudbackend.domain.enums.Perfil;
...
import com.rhinodevs.crudbackend.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "wwillers7@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "William Willers", "novusdevelopersteam@gmail.com", "28000565099", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("998552854", "35110000"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Apto 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Alguma Coisa", "2020", null, "Centro", "78555555", cli2, c2);
		...
		cli1.getPedididos().addAll(Arrays.asList(ped1, ped2));
