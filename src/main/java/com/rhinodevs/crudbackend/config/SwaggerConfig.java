...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).useDefaultResponseMessages(false)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.rhinodevs.crudbackend.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do curso Spring Boot",
				"Esta API foi desenvolvida no curso de Spring Boot do prof. Nelio Alves", "Versão 1.0",
